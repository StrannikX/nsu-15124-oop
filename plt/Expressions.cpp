...
void Number::print(QTextStream& out) {
    out << number;
}
...
void Variable::print(QTextStream& out) {
    out << var;
}
...
void Add::print(QTextStream& out) {
    out << "( ";
    left->print(out);
    out << " ) + ( ";
    right->print(out);
...
void Sub::print(QTextStream& out) {
    out << "( ";
    left->print(out);
    out << ") - (";
    right->print(out);
...
void Mul::print(QTextStream& out) {
    out << "( ";
    left->print(out);
    out << ") * (";
    right->print(out);
...
void Div::print(QTextStream& out) {
    out << "( ";
    left->print(out);
    out << " ) / ( ";
    right->print(out);
...
void Minus::print(QTextStream& out) {
    out << '-';
    val->print(out);
}
...
void Sin::print(QTextStream& out) {
    out << "sin(";
    val->print(out);
    out << ")";
}
...
void Cos::print(QTextStream& out) {
    out << "cos(";
    val->print(out);
    out << ")";
}
